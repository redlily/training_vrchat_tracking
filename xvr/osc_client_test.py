...
def main():
    ...
    for x in range(10000000):
        client.send_message(f"/tracking/trackers/1/position", [-0.125, 0.2, 0.0]) # right feet
        client.send_message(f"/tracking/trackers/1/rotation", [0.0, 0.0, x / 100])
        client.send_message(f"/tracking/trackers/2/position", [0.125, 0.2, 0.0]) # left feet
